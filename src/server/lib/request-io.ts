...
export function get (options: io.GetOptions): Bluebird<io.Response> {
  return Bluebird.fromCallback((cb) => {
    request.get(asRequestOptions(options), (error: any, response: any, body: any) => {
      if (error) {
        return cb(error);
      }
...
export function post (options: io.PostOptions): Bluebird<io.Response> {
  return Bluebird.fromCallback((cb) => {
    request.post(asRequestOptions(options), (error: any, response: any, body: any) => {
      if (error) {
        return cb(error);
      }
      if (response.statusCode === undefined) {
...
export function put (options: io.PutOptions): Bluebird<io.Response> {
  return Bluebird.fromCallback((cb) => {
    request.put(asRequestOptions(options), (error: any, response: any, body: any) => {
      if (error) {
        return cb(error);
      }
      if (response.statusCode === undefined) {

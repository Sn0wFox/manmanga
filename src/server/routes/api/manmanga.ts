...
// TODO: gotta rework this router

const manmangaApiRouter: Router = Router();
 ...
 */
manmangaApiRouter.get('/isManga/:resource', async (req: Request, res: Response) => {
...
manmangaApiRouter.get('/resource/:name', async (req: Request, res: Response) => {
  try {
...
manmangaApiRouter.get('/manga/:name', async (req: Request, res: Response) => {
  ...
  try {
    const cover: MangaCover = await mcdIOSphere.getMangaCoverUrl(mangaName.replace(/_/g, ' '));
 ...
 */
manmangaApiRouter.get('/api/sparql/anime/:name', async (req: Request, res: Response) => {
  try {
 ...
 * or a 500 error if there was a problem with the request.
 */
manmangaApiRouter.get('/api/sparql/author/:name', async (req: Request, res: Response) => {
  try {
 ...
 * or a 404 error if there was a problem with the request.
 */
manmangaApiRouter.get('/character/:name', async (req: Request, res: Response) => {
  try {
...
manmangaApiRouter.get('/manga/:name/coverUrl', async (req: Request, res: Response) => {
  try {
    const mangaName: string = req.params['name'];
    const cover: MangaCover = await mcdIOSphere.getMangaCoverUrl(mangaName);
